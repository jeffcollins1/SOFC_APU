function [param_od] = run_cycle_od_b(OD,options,z)
...
A1.O2 = .21*OD.air_in;
A1.N2 = .79*OD.air_in;
[OTM_od,A2,A3,A3b,A4,A5,O1,O2,O3,O4,O5] = OxygenModule_od_b(OD,A1,bypass,z);
% for i = 1:10
%     for j = 1:10
% if OTM_od.Rt(i,j) < 0
%    O5.O2(i,j) = NaN;
...
Pinmotor = OD.Pinmotor;
[HL_od,F1,F2,F3,F4,E2,E3,E4] = HeatLoop_b(OD,FC_od,OTM_od,E1,A2,A3,A4,Pinmotor);
...
param_od.bpr = bypass;
param_od.states = {'A1',A1;'A2',A2;'A3',A3;'A3b',A3b;'A4',A4;'A5',A5;'E1',E1;'E2',E2;'E3',E3;'E4',E4;'F1',F1;'F2',F2;'F3',F3;'F4',F4;'O1',O1;'O2',O2;'O3',O3;'O4',O4;'O5',O5;};
...
%  param_od.X_dest_recirc = -HL_od.blower_work -15850 + FC_od.Qremove.*(1-OD.T0/350) + 19109 - 133.11;
 ...
 param_od.Qbalmotor = HL_od.Qbalancemotors;
