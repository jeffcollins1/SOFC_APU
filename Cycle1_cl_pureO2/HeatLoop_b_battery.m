function [HeatLoop,F1,F2,F3,F4,E2,E3,E4] = HeatLoop_b_battery(options,OD,FC,OTM,E1,A2,A3,A4)
F0.T = 20*ones(10,10);
...
F0.H2 = FC.H2_supply;
HeatLoop.Qbalancemotors = OD.Pinmotor*(1-0.987)*ones(10,10) - (property(F1,'h','kJ') - property(F0,'h','kJ')); 
