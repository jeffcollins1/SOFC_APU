%%  Test Cycle b
%Create options to test and uses heat from the turbine inlet in place of H2
%for heat 
...
options.T_otm = options.T_fc + 0.5*options.dT_fc; %Operating temperature for OTM
...
for y = 1:1
    options.P_perm = ones(10,1)*linspace(35,P_permmax,10); 
    [Design,param] = run_cycle_b_Qrecover(options,param,Demand,P_non_perm);
...
%%sized for minimum SOFC size at cruise with i_den < 1 A/cm^2; 

% DesignOptionsTotalPower = [38.21401966	41.90166312	46.97639568	53.43821732	56.90594004	65.44839532	69.60966259	73.77092986	77.93219713	89.94237513;...
% 283.7227683	322.2530208	360.7832733	399.3135258	437.8437783	476.3740307	514.9042832	553.4345357	591.9647882	630.4950407;...
% 62368.94849	62368.94849	62368.94849	62368.94849	62368.94849	62368.94849	62368.94849	62368.94849	62368.94849	62368.94849;...
% 0.777693686	0.778178266	0.778462801	0.780216877	0.779457093	0.778839695	0.783545223	0.782057883	0.783630506	0.780561391;...
% 0.699868915	0.695239429	0.695417007	0.699009241	0.695181438	0.692609865	0.700369379	0.698483064	0.696847239	0.698605101;...
% 0.895740207	0.946077162	0.944148767	0.905098249	0.946706871	0.974612006	0.890290032	0.910823522	0.928611213	0.909495814;...
% 0.899410495	0.893461083	0.893689291	0.898305716	0.893386557	0.890081797	0.900053647	0.89762952	0.8955273	0.897786351;...
% 55855.05701	55721.61806	55574.001	55589.64452	55396.92839	55456.15904	55748.28415	55326.98897	55461.89082	55718.74499;...
% 33828.99069	31147.78914	31125.90963	33334.49602	30946.60728	36008.95574	34762.80003	32977.1654	32451.1075	40087.70993;...
% -24273.64711	-21564.04104	-21545.33793	-23937.92835	-21425.91471	-26696.26211	-25825.06498	-23692.90022	-23350.40795	-31390.86315;...
% -201.3305908	-202.1870325	-201.5999082	-200.6203358	-201.0256573	-201.9877757	-200.8021361	-199.8228406	-200.7802825	-201.2025806;...
% 0.64364035	0.646378336	0.644501339	0.641369712	0.642665498	0.645741325	0.641950915	0.638820174	0.641881051	0.64323111;...
% 0	16.62001286	0	0	0	0	130.2020887	0	116.0014777	0;...
% 6933.020427	6592.06559	6586.348104	6837.132694	6549.840769	6392.755736	6957.153703	6767.147948	6669.325567	6823.820948;...
% 13.5	15.33333333	17.16666667	19	20.83333333	22.66666667	24.5	26.33333333	28.16666667	30;...
% 2.311006809	2.197355197	2.195449368	2.279044231	2.183280256	2.397283401	2.319051234	2.255715983	2.223108522	2.558932856]
...
mission = [];
tic
[param_od] = run_cycle_od_b_Qrecovery(OD,options,z);
toc
