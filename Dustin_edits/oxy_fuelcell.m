...
FC.Qremove = FC.Qgen - (H_anode_out - enthalpy(F5) - enthalpy(Cathode));%(property(Exhaust,'h','kJ')-property(F5,'h','kJ')-property(Cathode,'h','kJ')); %heat removed by some means to maintain temperature in kW
FC.O2 = Cathode.O2;
FC.pressure = P;
end