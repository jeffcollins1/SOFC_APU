...
T = 245196;% Thrust in N:  Thrust = Cd/Cl*Weight; cruise Cd = 0.036; Cl = .48; weight = 735,000lbs; thus 55,000lbs cruise thrust. Makes sens because max thrust at cruise is 100,000lbs.
P = T.*V./options.pro_eff;%propellor momentum theory at cruise http://164.100.133.129:81/econtent/Uploads/09-%20Ducted%20Fans%20and%20Propellers%20%5BCompatibility%20Mode%5D.pdf ,  http://web.mit.edu/16.unified/www/SPRING/systems/Lab_Notes/airpower.pdf
...
batteryweight = batteryboost*param.P_to/1260; %battery weight required to assist with takeoff assuming battery energy storage of 1260 kJ/kg;
...
Weight.Total = (Weight.sofc + Weight.otm + Weight.comp + Weight.turb + Weight.hx + Weight.motor); 
...
Weight.Fuel = ???; %Total LH2 storage including weight of insulated container
Weight.Payload = ????;
end