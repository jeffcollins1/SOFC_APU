...
options.propulsor_weight = 2*6033*ones(n1,n2); %Weight
...
options.air_frame_weight = (options.TO_weight - FuelUsed - StandardPayload - RRTrent1000engine)*ones(n1,n2);%airframe mass in kg: Max Fuel = 101000 kg.  Max payload = 112760 kg.  4 engines, each 9670lb
...
options.propulsor_weight = 0.3*2*RRTrent1000engine; %Weight propulsor portion (30%) 
