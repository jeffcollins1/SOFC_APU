function [param,Design,HL,intake] = run_cycle_3(options,FCArray,E1,A1)

[intake,A2,A3] = intake_cycle_3(options,FCArray,A1);
[HL,F1,F2,F3,F4,E1,E2,E3,E4,A4] = HeatLoop_3(intake,options,FCArray,A3)
[Weight,param] = NetParam_3(options,FCArray,intake,HL,E4);
[Design] = sizer_3(options,param,Weight,HL);
