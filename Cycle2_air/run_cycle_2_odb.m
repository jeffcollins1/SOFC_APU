function [Weight,paramod] = run_cycle_2_odb(options,FCArray,E1,A1,Cells)

[intake,A2,A3,A4,A5] = intake_cycle_odb(options,FCArray);
[HL,F1,F2,F3,F4,E2,E3,E4] = HeatLoop_2odb(intake,options,FCArray,E1,A4);
[Weight,paramod] = NetParam_2odb(options,FCArray,intake,HL,A1,Cells);
