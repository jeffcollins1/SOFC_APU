function [Weight,paramod] = run_cycle_2Cruise(options,FCArray,E1,A1,Cruise)

[intake,A2,A3,A4,A5] = intake_cycleCruise(options,FCArray,Cruise,A1);
[HL,F1,F2,F3,F4,E2,E3,E4] = HeatLoop_2(intake,options,FCArray,E1,A4);
[Weight,paramod] = NetParam_2(options,FCArray,intake,HL);
% [OffDesign] = condition_2(Cruise,param,FCArray)
OffDesign.states = {'A1',A1;'A2',A2;'A3',A3;'A4',A4;'A5',A5;'E1',E1;'E2',E2;'E3',E3;'E4',E4;'F1',F1;'F2',F2;'F3',F3;'F4',F4;};
[m,n] = size(OffDesign.states);
% for i = 1:1:m
