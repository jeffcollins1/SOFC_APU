function [param,Design,HL,intake] = run_cycle_2b(options,FCArray,E1,A1)

[intake,A2,A3,A4] = intake_cycle(options,FCArray,A1);
[HL,F1,F2,F3,F4,E2,E3,E4,A5] = HeatLoop_2(intake,options,FCArray,E1,A4);
[Weight,param] = NetParam_2(options,FCArray,intake,HL);
[Design] = sizer_2b(options,param,Weight,HL);
Design.states = {'A1',A1;'A2',A2;'A3',A3;'A4',A4;'A5',A5;'E1',E1;'E2',E2;'E3',E3;'E4',E4;'F1',F1;'F2',F2;'F3',F3;'F4',F4;};
